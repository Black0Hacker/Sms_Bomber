...
/*
tlegeram:  @id_abol_hacker or 
===============================================
#کص مادر کسی که ادیت بزنه
===============================================
Sms Bomber pro v1
*/
func clearScreen() {
...
__   _____________________________________________________________   __
  | |                                                             | |  
	`)
	var phone string
	fmt.Println("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;31mSms : \033[01;33m200 \n\033[01;31m[\033[01;32m+\033[01;31m] \033[01;31mCall : \033[01;33m6\n\n")
	fmt.Print("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;32mEnter the target number [Ex : 09xxxxxxxxxx]: \033[00;36m")
	fmt.Scan(&phone)
	...
	for i := 0; i < repeatCount*183; i++ {
		...
		if statusCode == 404 || statusCode == 400 {
			...
			fmt.Println("\033[01;31m[\033[01;32m+\033[01;31m] \033[01;32mSuccessful...")
		}
